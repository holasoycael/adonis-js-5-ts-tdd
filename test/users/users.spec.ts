...
test.group('User', (group) => {
  ...
  test('it should update an user', async (assert) => {
    ...
    const avatar = 'http://github.com/holasoycael.png'
  ...
  test('is should update the password of the user', async (assert) => {
  ...
  test('is should return 422 when required data is not provided', async (assert) => {
